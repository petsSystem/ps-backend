...
//        return scheduleService.partialUpdate(scheduleId, patch);
//    }
//
...
//        return scheduleService.get(authentication, pageable, filter);
//    }
//
//    //ACESSO: ALL
//    @Operation(summary = "Serviço de recuperação das informações da agenda no sistema através do id.",
//            description = "Acesso: ALL")
//    @ApiResponses(value = {
//            @ApiResponse(
//                    responseCode = "400",
...
//            Principal authentication,
//            @PathVariable("scheduleId") UUID scheduleId) {
//        return scheduleService.getById(authentication, scheduleId);
//    }
//
//    //ACESSO: ALL
...
//        return scheduleService.updateById(authentication, scheduleId, request);
//    }
//
//    //ACESSO: 'ADMIN'
